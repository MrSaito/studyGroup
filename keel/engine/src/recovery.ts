...
const STRINGS: Record<string, Strings> = {
  ...
  // ar / zh / ru / es: machine drafts (session 6) — native review required, same as ur.
  ar: {
    returnTitle: "العودة",
    youWrote: "كتبتَ:",
    noHistory: "لم تُكمل أي وحدة بعد — هذه بداية جديدة.",
    doRecent: "أعد قراءة ملاحظاتك أعلاه وأعد جزءاً صغيراً من",
    thenNext: "ثم أنت جاهز لـ",
    doFirst: "افتح الوحدة الأولى ونفّذ خطوتها الأولى فقط.",
    tip: "عشر دقائق هي المهمة كلها. توقف عندما يتوقف المؤقت.",
    halfSize: "(أسبوع بنصف الحجم)",
  },
  zh: {
    returnTitle: "重新开始",
    youWrote: "你写道：",
    noHistory: "你还没有完成任何单元——这是一个全新的开始。",
    doRecent: "重读上面的笔记，重做其中一小部分：",
    thenNext: "然后你就可以开始",
    doFirst: "打开第一个单元，只做它的第一步。",
    tip: "十分钟就是全部任务。计时器停，你就停。",
    halfSize: "（减半周）",
  },
  ru: {
    returnTitle: "Возвращение",
    youWrote: "вы написали:",
    noHistory: "Вы ещё не завершили ни одного блока — это чистый старт.",
    doRecent: "Перечитайте заметки выше и повторите один небольшой кусочек из",
    thenNext: "Затем вы готовы к",
    doFirst: "Откройте первый блок и сделайте только его первый шаг.",
    tip: "Десять минут — это вся задача. Таймер остановился — остановитесь и вы.",
    halfSize: "(Неделя вполовину)",
  },
  es: {
    returnTitle: "Reentrada",
    youWrote: "escribiste:",
    noHistory: "Aún no has completado ninguna unidad: este es un comienzo limpio.",
    doRecent: "Relee tus notas de arriba y repite una parte pequeña de",
    thenNext: "Después estarás listo para",
    doFirst: "Abre la primera unidad y haz solo su primer paso.",
    tip: "Diez minutos son toda la tarea. Para cuando pare el temporizador.",
    halfSize: "(Semana a medias)",
  },
};
