...
const t: Partial<Strings> = {
  ...
  backupSync: "Резервная копия и синхронизация", // draft
  syncSoon: "Вход и синхронизация между устройствами появятся в следующем выпуске.", // draft
  syncHint: "Необязательно. Войдите, чтобы сохранить план и историю и пользоваться Keel на другом телефоне. Пока вы не войдёте, ничего не покидает это устройство.", // draft
  email: "Электронная почта", // draft
  sendCode: "Прислать код", // draft
  codeLabel: "6-значный код из письма", // draft
  verify: "Подтвердить", // draft
  signInFail: "Не удалось отправить код:", // draft
  codeFail: "Код не подошёл. Проверьте письмо и попробуйте снова.", // draft
  offlineHint: "Сейчас нет соединения. Попробуйте, когда будете онлайн.", // draft
  lastSynced: "Последняя синхронизация", // draft
  syncing: "Синхронизация…", // draft
  syncOffline: "Офлайн — изменения синхронизируются, когда вы вернётесь в сеть.", // draft
  syncError: "Синхронизация столкнулась с проблемой; повторим позже.", // draft
  syncReauth: "Войдите снова, чтобы продолжить синхронизацию. Ничего не потеряно.", // draft
  syncNow: "Синхронизировать сейчас", // draft
  signOut: "Выйти", // draft
  signOutKeep: "Вы вышли. План остаётся на этом устройстве.", // draft
  haveAccount: "Я уже пользуюсь Keel на другом телефоне", // draft
  reminders: "Напоминания", // draft
  remindersHint: "Одно напоминание в момент вашего сигнала, второе через 90 минут с 10-минутным вариантом. Никогда больше двух. Тихие часы соблюдаются.", // draft
  remindAt: "Напоминать в", // draft
  quietFrom: "Тихие часы с", // draft
  quietTo: "до", // draft
  remindersOn: "Включить напоминания", // draft
  remindersOff: "Выключить напоминания", // draft
  pushDenied: "Уведомления для Keel заблокированы в настройках браузера.", // draft
  pushUnsupported: "Для напоминаний установите Keel на главный экран (Добавить на главный экран, затем откройте заново).", // draft
  deleteAccount: "Удалить мой аккаунт", // draft
  deleteAccountConfirm: "Это удалит ваш аккаунт и всё, что с ним синхронизировано. Локальная копия тоже будет удалена. Продолжить?", // draft
  linkOrCode: "Проверьте почту. Нажмите на ссылку в письме или введите код здесь, если он есть.", // draft
};
export default t;
